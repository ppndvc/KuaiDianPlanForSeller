...
@interface KDChangePasswordViewModel : KDBaseViewModel
...
//开始修改密码请求，带有开始和结束回调
-(void)changePWDWithParams:(NSDictionary *)params beginBlock:(KDViewModelBeginCallBackBlock)beginBlock completeBlock:(KDViewModelCompleteCallBackBlock)completeBlock;
