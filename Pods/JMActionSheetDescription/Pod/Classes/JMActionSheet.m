...
+(void)showActionSheet:(JMActionSheetDescription *)actionSheetDescription
{
    [JMActionSheet showActionSheetDescription:actionSheetDescription inViewController:[UIApplication sharedApplication].keyWindow.rootViewController fromView:nil permittedArrowDirections:UIPopoverArrowDirectionAny];
}
